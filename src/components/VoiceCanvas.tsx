...
export function VoiceCanvas({ groups, showGrid, onEngineReady }: VoiceCanvasProps) {
  ...
  return (
    <div className="relative flex min-h-0 flex-1 items-center justify-center px-4 pb-28 pt-2 sm:px-7 sm:pb-32">
      <div className="absolute left-7 top-5 z-20 flex items-center gap-2 text-[10px] font-bold uppercase tracking-[0.22em] text-slate-500">
