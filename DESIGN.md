...
项目重点不是生成写实图片，而是验证一种清晰的新交互：**把自然语言转化为可解释、可撤销、可组合、可继续编辑的智能矢量插画对象。**
...
最终实现覆盖基础图形、房子/笑脸/太阳复合图形，以及夜晚城市、宇宙星空、海边日落、森林和机器人五种高级插画场景。支持五种全局风格，并可通过语音删除、复制、缩放、移动和变色最后一个对象。
